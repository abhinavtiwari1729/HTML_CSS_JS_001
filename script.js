...
const locations = [
...

  {
    ...
    name: "store",
    "button text": ["Buy 10 health (10 gold)", "Buy weapon (30 gold)", "Go to Ayodhya"],
  ...
  {
    name: "cave",
    "button text": ["Fight KumbhKaran", "Fight Meghnad", "Go To Ayodhya"],
  ...
  {
    name: "kill monster",
    "button text": ["Go to Ayodhya", "Go to Ayodhya", "Go to Ayodhya"],
